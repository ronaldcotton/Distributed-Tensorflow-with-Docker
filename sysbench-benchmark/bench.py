...
# NOTE: install with version 0.4.12

# installing sysbench
# debian/ubuntu (up to 16.04 LTS):
#    sudo apt-get install sysbench
# after ubuntu 16.04 (assuming intel64 install):
#    go to https://packages.ubuntu.com/trusty/amd64/sysbench/download
#    choose a mirror to download
#    once confirming checksum
#    dpkg -i sysbench_0.4.12-1.1_amd64.deb
#
...
def main():
    ...
    deleteDirectory(benchmark_dir)                # create directory structure - if filename is the same - delete
